...
import {
	...
	StyledHtmlMobile,
	ImgContainerMobile,
} from '../HeroContainer/HeroContainer.styles'
...
const HeroContainer = ({ isOpen, setOpen }) => {
	return (
		<Wrapper id='#/'>
			<Container>
				<InfoContainer variants={slideLeft} custom={{ delay: 0.5 }} initial='initial' animate='animate'>
					<FirstPa>
						Hello world, <WaveIcon>👋</WaveIcon> I'm{' '}
					</FirstPa>
					<SecondPa variants={scaleY} custom={1} initial='initial' animate='animate'>
						Jakub Karbowski
					</SecondPa>
				...
				<Background>
					<InfoContainerMobile variants={slideLeft} custom={{ delay: 0.5 }} initial='initial' animate='animate'>
						<FirstPa>
							Hello world, <WaveIcon>👋</WaveIcon> I'm{' '}
						</FirstPa>
						<SecondPa variants={scaleY} initial='initial' animate='animate' custom={1}>
							Jakub Karbowski
						</SecondPa>
						<ThirdPa>Frontend Developer</ThirdPa>
						<Link href='#portfolio'>
					...
					<ImgContainerMobile variants={slideRight} custom={{ delay: 0.6 }} initial='initial' animate='animate'>
						<Image src={require('../../../assets/img/person-image.png')} alt='logo' objectFit='cover' />
					</ImgContainerMobile>

					<ImgContainer variants={slideRight} custom={{ delay: 0.6 }} initial='initial' animate='animate'>
